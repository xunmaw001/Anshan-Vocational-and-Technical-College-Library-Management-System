...
<div class="recommend" :style='{"border":"0px solid #dfdfdf","boxShadow":"0px 0px 0px #eee","margin":"0px 0 0px","overflow":"hidden","borderRadius":"0px","background":"url(http://codegen.caihongy.cn/20221116/128d20a6d6e849909208616b29db4994.jpg) fixed no-repeat center bottom","width":"100%","height":"auto","order":"1"}'>
    ...
    <div class="title" :style='{"width":"100%","padding":"0 0 30px","margin":"40px 0 24px 0","lineHeight":"1.5","textAlign":"center","background":"url(http://codegen.caihongy.cn/20221116/5fc6dea31a6b44c48f3b249bafc81705.png) no-repeat center bottom"}'>
		<span :style='{"fontSize":"24px","color":"#FFA100","textShadow":"2px 4px 2px #eee","fontWeight":"bold"}'>图书信息推荐</span>
	</div>
	...
	<div class="list list1 index-pv1" :style='{"padding":"20px 20px","margin":"0 auto","borderRadius":"12px","flexWrap":"wrap","background":"none","display":"flex","width":"1200px","justifyContent":"space-between","height":"auto"}'>
		<div :style='{"margin":"0px 0 20px","borderRadius":"8px","background":"none","display":"inline-block","width":"32%","position":"relative","height":"auto"}' v-for="(item,index) in tushuxinxiRecommend" :key="index" @click="toDetail('tushuxinxiDetail', item)" class="list-item animation-box">
			<img :style='{"cursor":"pointer","boxShadow":"1px 1px 1px #ddd","padding":"8px","borderColor":"#ffa100","objectFit":"cover","borderRadius":"20%","borderWidth":"3px","background":"#f5f6cb","display":"block","width":"100%","borderStyle":"dotted dashed solid double","height":"274px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
			<img :style='{"cursor":"pointer","boxShadow":"1px 1px 1px #ddd","padding":"8px","borderColor":"#ffa100","objectFit":"cover","borderRadius":"20%","borderWidth":"3px","background":"#f5f6cb","display":"block","width":"100%","borderStyle":"dotted dashed solid double","height":"274px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
			<div class="name line1" :style='{"cursor":"pointer","padding":"4px 10px","boxShadow":"0px 2px 0px #f1e288","margin":"4px auto 0 auto","whiteSpace":"nowrap","color":"#333","textAlign":"center","fontStyle":"italic","transform":"rotate(0deg)","overflow":"hidden","borderRadius":"20% ","background":"#fff","width":"76%","lineHeight":"24px","fontSize":"14px","textOverflow":"ellipsis"}'>{{item.tushumingcheng}}</div>
			<div class="name line1" :style='{"cursor":"pointer","padding":"4px 10px","boxShadow":"0px 2px 0px #f1e288","margin":"4px auto 0 auto","whiteSpace":"nowrap","color":"#333","textAlign":"center","fontStyle":"italic","transform":"rotate(0deg)","overflow":"hidden","borderRadius":"20% ","background":"#fff","width":"76%","lineHeight":"24px","fontSize":"14px","textOverflow":"ellipsis"}'>{{item.tushufenlei}}</div>
			<div class="name line1" :style='{"cursor":"pointer","padding":"4px 10px","boxShadow":"0px 2px 0px #f1e288","margin":"4px auto 0 auto","whiteSpace":"nowrap","color":"#333","textAlign":"center","fontStyle":"italic","transform":"rotate(0deg)","overflow":"hidden","borderRadius":"20% ","background":"#fff","width":"76%","lineHeight":"24px","fontSize":"14px","textOverflow":"ellipsis"}'>数量:{{item.shuliang}}</div>
		</div>
	</div>
	...
	<div @click="moreBtn('tushuxinxi')" :style='{"border":"1px solid #ffa100","cursor":"pointer","boxShadow":"0px 4px 1px #ddd5c6,inset 0px 0px 56px 0px #ffa100","margin":"30px auto 40px","borderRadius":"4px","textAlign":"center","background":"#fff","display":"block","width":"150px","lineHeight":"44px"}'>
...
<div class="news" :style='{"border":"0px solid #dfdfdf","padding":"0px","boxShadow":"0px 2px 3px #eee","margin":"20px auto 0px auto","overflow":"hidden","borderRadius":"0px","background":"url(http://codegen.caihongy.cn/20221116/0c7a84c17e434d23ab0e8817e3db9c50.jpg) fixed no-repeat center top","width":"100%","height":"auto","order":"6"}'>
	...
	<div class="title" :style='{"width":"100%","padding":"0 0 30px","margin":"40px 0 30px 0","lineHeight":"1.5","textAlign":"center","background":"url(http://codegen.caihongy.cn/20221116/5fc6dea31a6b44c48f3b249bafc81705.png) no-repeat center bottom"}'>
		<span :style='{"fontSize":"24px","color":"#ffa100","textShadow":"2px 4px 2px #eee","fontWeight":"bold"}'>通知公告</span>
	</div>
