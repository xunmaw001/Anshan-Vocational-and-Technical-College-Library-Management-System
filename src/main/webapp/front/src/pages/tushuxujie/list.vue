...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","margin":"0 auto","borderColor":"#ffc800","alignItems":"center","display":"flex","borderRadius":"0 0 12px 12px","flexWrap":"wrap","background":"#fbf9f3","borderWidth":"0 1px 1px 1px","width":"1200px","borderStyle":"solid","height":"auto","order":"2"}'>
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>续借编号</div>
        <el-input v-model="formSearch.xujiebianhao" placeholder="续借编号" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"0 10px"}'>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        let searchWhere = {};
        if (this.formSearch.xujiebianhao != '') searchWhere.xujiebianhao = '%' + this.formSearch.xujiebianhao + '%';
