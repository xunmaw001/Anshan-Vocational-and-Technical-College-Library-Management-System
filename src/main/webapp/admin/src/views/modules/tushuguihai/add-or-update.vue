<template>
	<div class="addEdit-block" :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20230303/76c3e36e1fa546ef8e134d65e6665618.jpg) center bottom/cover no-repeat fixed","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="归还编号" prop="guihaibianhao">
					<el-input v-model="ruleForm.guihaibianhao" placeholder="归还编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.guihaibianhao" label="归还编号" prop="guihaibianhao">
					<el-input v-model="ruleForm.guihaibianhao" placeholder="归还编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="归还时间" prop="guihaishijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.guihaishijian" label="归还时间" prop="guihaishijian">
					<el-input v-model="ruleForm.guihaishijian" placeholder="归还时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="归还备注" prop="guihaibeizhu">
					<el-input v-model="ruleForm.guihaibeizhu" placeholder="归还备注" clearable  :readonly="ro.guihaibeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="归还备注" prop="guihaibeizhu">
