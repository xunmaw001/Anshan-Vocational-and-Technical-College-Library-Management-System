<template>
	<div class="addEdit-block" :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20230303/76c3e36e1fa546ef8e134d65e6665618.jpg) center bottom/cover no-repeat fixed","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="借阅编号" prop="jieyuebianhao">
					<el-input v-model="ruleForm.jieyuebianhao" placeholder="借阅编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jieyuebianhao" label="借阅编号" prop="jieyuebianhao">
					<el-input v-model="ruleForm.jieyuebianhao" placeholder="借阅编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="借阅天数" prop="jieyuetianshu">
					<el-input v-model="ruleForm.jieyuetianshu" placeholder="借阅天数" clearable  :readonly="ro.jieyuetianshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="借阅天数" prop="jieyuetianshu">
					<el-input v-model="ruleForm.jieyuetianshu" placeholder="借阅天数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="借阅时间" prop="jieyueshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jieyueshijian" label="借阅时间" prop="jieyueshijian">
					<el-input v-model="ruleForm.jieyueshijian" placeholder="借阅时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="借阅备注" prop="jieyuebeizhu">
					<el-input v-model="ruleForm.jieyuebeizhu" placeholder="借阅备注" clearable  :readonly="ro.jieyuebeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="借阅备注" prop="jieyuebeizhu">
					<el-input v-model="ruleForm.jieyuebeizhu" placeholder="借阅备注" readonly></el-input>
				</el-form-item>
