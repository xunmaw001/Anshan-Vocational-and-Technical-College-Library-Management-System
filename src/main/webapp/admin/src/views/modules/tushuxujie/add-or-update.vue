<template>
	<div class="addEdit-block" :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20230303/76c3e36e1fa546ef8e134d65e6665618.jpg) center bottom/cover no-repeat fixed","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="续借编号" prop="xujiebianhao">
					<el-input v-model="ruleForm.xujiebianhao" placeholder="续借编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.xujiebianhao" label="续借编号" prop="xujiebianhao">
					<el-input v-model="ruleForm.xujiebianhao" placeholder="续借编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="ISBN编号" prop="bianhao">
					<el-input v-model="ruleForm.bianhao" placeholder="ISBN编号" clearable  :readonly="ro.bianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="ISBN编号" prop="bianhao">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="续借天数" prop="xujietianshu">
					<el-input v-model="ruleForm.xujietianshu" placeholder="续借天数" clearable  :readonly="ro.xujietianshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="续借天数" prop="xujietianshu">
					<el-input v-model="ruleForm.xujietianshu" placeholder="续借天数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="续借日期" prop="xujieriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.xujieriqi" label="续借日期" prop="xujieriqi">
					<el-input v-model="ruleForm.xujieriqi" placeholder="续借日期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="续借原因" prop="xujieyuanyin">
					<el-input v-model="ruleForm.xujieyuanyin" placeholder="续借原因" clearable  :readonly="ro.xujieyuanyin"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="续借原因" prop="xujieyuanyin">
					<el-input v-model="ruleForm.xujieyuanyin" placeholder="续借原因" readonly></el-input>
				</el-form-item>
