	...
	<div class="addEdit-block" :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20230303/76c3e36e1fa546ef8e134d65e6665618.jpg) center bottom/cover no-repeat fixed","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="提醒内容" prop="tixingneirong">
					<el-input v-model="ruleForm.tixingneirong" placeholder="提醒内容" clearable  :readonly="ro.tixingneirong"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="提醒内容" prop="tixingneirong">
