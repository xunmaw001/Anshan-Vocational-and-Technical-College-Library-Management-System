	...
	<div class="addEdit-block" :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20230303/76c3e36e1fa546ef8e134d65e6665618.jpg) center bottom/cover no-repeat fixed","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.bianhao" label="ISBN编号" prop="bianhao">
					<el-input v-model="ruleForm.bianhao" placeholder="ISBN编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="出版日期" prop="chubanriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.chubanriqi" label="出版日期" prop="chubanriqi">
					<el-input v-model="ruleForm.chubanriqi" placeholder="出版日期" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.tushuxiangqing = this.ruleForm.tushuxiangqing.replace(reg,'../../../ssm1o9rw/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
